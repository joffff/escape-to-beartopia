...
const CHARACTERS = [
  {
    id: 'carlo',
    name: 'Carlo Bear',
    image: '/images/mini-games/berry-forest/carlo-bear.jpg',
    description: 'A tough bear with a rebellious spirit and leather jacket'
  },
  {
    id: 'scotty',
    name: 'Scotty Bear',
    image: '/images/mini-games/berry-forest/scotty-bear.jpg',
    description: 'A chill bear who keeps it cool with his signature cap'
  },
  {
    id: 'toli',
    name: 'Toli Bear',
    image: '/images/mini-games/berry-forest/toli-bear.jpg',
    description: 'A groovy bear spreading good vibes in tie-dye'
  }
];

function CharacterSelect({ onCharacterSelect }: CharacterSelectProps) {
  return (
