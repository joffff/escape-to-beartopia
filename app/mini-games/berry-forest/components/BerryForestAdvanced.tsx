...
const SPECIAL_TILES: SpecialTiles = {
  ...
  const handleSpecialTile = (tile: SpecialTile) => {
    ...
    switch (tile.type) {
      ...
      case 'rotten':
        ...
        break;
      case 'finalBerry':
        setScore(prev => prev + (tile.effect as number));
        setTimeout(() => {
          setShowMessage(false);
          setGameStatus('won');
        }, 2000);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 transform transition-all hover:shadow-2xl overflow-hidden">
            <div className="relative">
              {/* Forest background */}
              <div 
                className="absolute inset-0 bg-[url('/images/mini-games/berry-forest/forest-map.jpg')] bg-cover bg-center rounded-lg"
                style={{ opacity: 0.8 }}
              ></div>
